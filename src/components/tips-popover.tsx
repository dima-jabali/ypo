			...
			>
				<li className="flex w-full items-center justify-start gap-2 border border-transparent rounded p-2 hover:bg-button-hover focus:border-link/50">
					...
					<p className="break-words text-sm leading-5 text-primary">
						Press <span className="font-bold tracking-wider">Ctrl+Space</span>{" "}
						to trigger auto suggest.
					</p>
				</li>
				...
				<li className="flex w-full items-center justify-start gap-2 border border-transparent rounded p-2 hover:bg-button-hover focus:border-link/50">
					...
					<p className="break-words text-sm leading-5 text-primary">
						Press <span className="font-bold tracking-wider">Esc</span> to close
				...
				<li className="flex w-full items-center justify-start gap-2 border border-transparent rounded p-2 hover:bg-button-hover focus:border-link/50">
					...
					<p className="break-words text-sm leading-5 text-primary">
						Press <span className="font-bold tracking-wider">Tab</span> to
						accept a suggestion.
					</p>
				</li>
			</PopoverContent>
