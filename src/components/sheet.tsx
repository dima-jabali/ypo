  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={classNames(
          "bg-popover data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col p-4 gap-4 shadow-lg transition border-border-smooth ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
