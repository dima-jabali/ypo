    ...
    <Card className="h-fit p-0 transition-colors" id={profile.id}>
      <CardContent className="p-4 space-y-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {profile.current_company_name && (
              <p
                ...
                title={profile.current_company_name}
              >
        ...
        <div className="flex flex-wrap gap-1.5">
          {profile.ypo_chapter && (
            <Badge variant="default" className="text-xs" title={profile.ypo_chapter}>
              {profile.ypo_chapter}
            </Badge>
          )}
          {profile.ypo_industry && (
            <Badge variant="secondary" className="text-xs" title={profile.ypo_industry}>
              {profile.ypo_industry}
            </Badge>
          )}
        </div>
