...
export const hasInputsInJson = (json: BotJsonMessage): json is ToolSelectionResponseJson => {
  return (
    json !== null &&
    json !== undefined &&
    "tool" in json &&
...
export const hasOutputsInJson = (json: BotJsonMessage): json is ToolResponseJson => {
  return (
    json !== null &&
    json !== undefined &&
    "tool" in json &&
...
export const hasAnswersInJson = (json: BotJsonMessage): json is ToolResponseJson => {
  return (
    json !== null &&
    json !== undefined &&
    "tool" in json &&
