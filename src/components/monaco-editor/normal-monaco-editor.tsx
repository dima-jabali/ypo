...
export const NormalMonacoEditor = memo(function NormalMonacoEditor(props: NormalMonacoEditorProps) {
  ...
  const readonlyWithCodeHighlight = isBlockReadonly || isBlockRunning || isFixingCode;
  const readonlyWithoutCodeHighlight = isFixingCode;
  const isReadonly = readonlyWithCodeHighlight || readonlyWithoutCodeHighlight;

  function localOnMount(monacoEditor: MonacoEditorType.IStandaloneCodeEditor, monaco: Monaco) {
