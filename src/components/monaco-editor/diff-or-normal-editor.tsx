...
import { NormalMonacoEditor, type NormalMonacoEditorProps } from "./normal-monaco-editor";

type Props = NormalMonacoEditorProps;

const shouldShowSideBySide = false;

export const DiffOrNormalEditor = memo(function DiffOrNormalEditor(props: Props) {
  ...
  function handleUseSimilarQueryOnTheRight() {
    ...
    if (!monacoDiffEditor) {
      console.info("handleUseRightSide: no monacoDiffEditor! This should not happen!", {
        blockDiffEditor,
        normalMonacoEditor,
        monacoDiffEditor,
      });
  ...
  function handleUseSimilarQueryOnTheLeft() {
    ...
    if (!monacoDiffEditor) {
      console.info("handleUseLeftSide: no monacoDiffEditor! This should not happen!", {
        blockDiffEditor,
        normalMonacoEditor,
        monacoDiffEditor,
      });
  ...
  function handleUseCodeOnTheRight() {
    ...
    if (!monacoDiffEditor) {
      console.info("handleUseCodeOnTheRight: no monacoDiffEditor! This should not happen!", {
        normalMonacoEditor,
        monacoDiffEditor,
        blockDiffEditor,
      });
  ...
  function handleUseCodeOnTheLeft() {
    ...
    if (!monacoDiffEditor) {
      console.info("handleUseCodeOnTheLeft: no monacoDiffEditor! This should not happen!", {
        blockDiffEditor,
        normalMonacoEditor,
        monacoDiffEditor,
      });
