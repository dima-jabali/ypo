...
export const DownloadAndShowFilePreview: React.FC<Props> = memo(
  function DownloadAndShowFilePreview({
    ...
    switch (mimeType) {
      ...
      case MimeType.Pdf:
        return <PdfPreview initialPage={initialPage} blob={blobQuery.data} className={className} />;
...
const PdfPreview: React.FC<{
  ...
  return fileUrl ? <NativePdfViewer fileBlobUrl={fileUrl} className={className} /> : null;
};
