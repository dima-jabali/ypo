...
export function matchIcon(
	...
	switch (name) {
		...
		case FormattingOptions.TextAlignCenter: {
			return (
				<AlignCenter className={classNames(DEFAULT_CLASSNAME, className)} />
			);
		}

		case FormattingOptions.TextAlignRight: {
			return (
				<AlignRight className={classNames(DEFAULT_CLASSNAME, className)} />
			);
		}
		...
		case "png":
			return (
				<ImageIcon
					className={classNames(DEFAULT_CLASSNAME, "fill-none", className)}
				/>
			);
		...
		case "pdf":
			return (
				<PdfIcon
					className={classNames("size-4 flex-none fill-destructive", className)}
				/>
			);
		...
		case "back":
			return (
				<ChevronLeft className={classNames(DEFAULT_CLASSNAME, className)} />
			);
		...
		case IconType.DATABASE:
			return (
				<Database
					className={classNames(
						DEFAULT_CLASSNAME,
						"fill-yellow-400 stroke-gray-700",
						className,
					)}
				/>
			);
		...
		case IconType.METABASE:
			return (
				<MetabaseIcon className={classNames(DEFAULT_CLASSNAME, className)} />
			);
		...
		case IconType.ORACLE:
			return (
				<span
					className={classNames(DEFAULT_CLASSNAME, "-m-0.5 h-4 w-0", className)}
				/>
			);
