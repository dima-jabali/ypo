...
type DiffEditorOptions = NonNullable<
	Parameters<MonacoType["editor"]["createDiffEditor"]>[1]
>;

type EditorOptions = NonNullable<
	ComponentProps<typeof MonacoEditor>["options"]
>;
