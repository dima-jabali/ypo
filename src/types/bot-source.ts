...
export type BotSource =
  // | NotionBotSource
  SlackBotSource | PDFBotSource | CSVBotSource | WebBotSource | GoogleDriveBotSource; // | GeneralBotSource;
...
export type PDFOrCSVSourceType = PDFBotSource["source_type"] | CSVBotSource["source_type"];
