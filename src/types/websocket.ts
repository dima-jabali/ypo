...
import type { BatchTableId, FileId, ISODateString, NotebookId, UUID } from "./general";
import type {
  BetterbrainUser,
  IndexingFileStep,
  NotebookBlockUuid,
...
type WebSocketMessagePayload<TData, TType extends WebsocketAction | WebsocketEvent> = {
...
type WebSocketMessageFromPayload<TPayload extends Record<string, unknown>> = TPayload &
...
>;
export type WebSocketCheckAuthAction = WebSocketMessageFromPayload<WebSocketCheckAuthPayload>;
...
export type WebSocketUnsubscribeBatchTableInputsPayload = WebSocketMessagePayload<
  { batch_table_id: number },
...
export type WebSocketAuthPayload = WebSocketMessagePayload<AuthActionData, WebsocketAction.Auth>;
export type WebSocketAuthAction = WebSocketMessageFromPayload<WebSocketAuthPayload>;
...
export type WebSocketAuthResponse = WebSocketMessage<AuthResponseData, WebsocketEvent.AuthResponse>;
...
type WebSocketStatusMessageResponse = WebSocketMessage<EmptyObject, WebsocketEvent.StatusMessage>;
