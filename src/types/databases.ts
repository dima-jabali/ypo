...
export type ClickUpWorkspaceStringId = Tagged<string, "ClickUpWorkspaceStringId">;
...
export type GoogleDriveDatabaseConnectionId = Tagged<number, "GoogleDriveDatabaseConnectionId">;
...
export type AirtableDatabaseConnectionId = Tagged<number, "AirtableDatabaseConnectionId">;
...
export type NormalDatabaseConnectionDataSchemaId = Tagged<
  ...
  "NormalDatabaseConnectionDataSchemaId"
>;
export type NormalDatabaseConnectionId = Tagged<number, "NormalDatabaseConnectionId">;
...
export const STANDARD_SCHEMA_KEYS_TO_ENTITY_TYPE: Record<StandardSchemaKeys, EntityType> = {
