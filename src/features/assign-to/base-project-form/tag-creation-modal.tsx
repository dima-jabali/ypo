...
export const TagCreationModal: React.FC<Props> = ({ setSelectedTags, allTags }) => {
  ...
  useLayoutEffect(() => {
    ...
    setTagName(
      (document.getElementById(CUSTOM_IDENTIFIER_FOR_TAG_INPUT) as HTMLInputElement | null)
        ?.value || "",
    );
  }, [isOpen]);
  ...
  return (
    <Dialog onOpenChange={setIsOpen} open={isOpen}>
      ...
      <DialogContent className="flex max-w-lg flex-col z-110" overlayClassName="z-110">
