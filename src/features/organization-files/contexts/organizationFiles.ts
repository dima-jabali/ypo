...
import type { GeneralFile, GeneralFileType, GoogleDriveFileId } from "#/types/notebook";
...
export const { Provider: OrganizationFilesStoreProvider, useStore: useOrganizationFilesStore } =
