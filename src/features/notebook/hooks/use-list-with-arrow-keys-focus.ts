...
const keysToAction = {
  ArrowRight(
    ...
    const nextListItem = currentListItemFocused.nextElementSibling as HTMLButtonElement | null;
  ...
  ArrowLeft(
    ...
    const prevListItem = currentListItemFocused.previousElementSibling as HTMLButtonElement | null;
