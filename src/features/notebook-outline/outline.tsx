    ...
    for (const uuid in allBlocks) {
      ...
      const block = (
        <DefaultSuspenseAndErrorBoundary
          ...
          key={uuid}
        >
          <Block showSimilarQueries={onBlockOfSimilarQueryClick} projectBlock={projectBlock} />
        </DefaultSuspenseAndErrorBoundary>
      );
  ...
  return (
    <>
      <Popover onOpenChange={setIsOpen} open={isOpen}>
        ...
        <PopoverContent className="flex flex-col w-[unset] z-500" side="bottom" align="end">
      ...
      <div className="simple-scrollbar scrollbar-stable" ref={filteredBlocksParentRef}>
