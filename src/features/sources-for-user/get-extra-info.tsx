import { GoogleDriveSourceType, SourceForUserType, StandardDocumentSourceType } from "#/types/chat";
...
import { GoogleDriveMinimalDetails, GoogleDriveVerboseDetails } from "./Snippets/google-drive";
import {
...
export function getExtraInfo(
  ...
  switch (sourceMainValues.normalizedSource.source_type) {
    case SourceForUserType.Airtable:
      return <AirtableTable normalizedSource={sourceMainValues.normalizedSource} />;

    case SourceForUserType.DataSchema:
      return <DataSchemaTable normalizedSource={sourceMainValues.normalizedSource} />;

    case SourceForUserType.Web:
      return <WebDescription normalizedSource={sourceMainValues.normalizedSource} />;

    case SourceForUserType.GoogleDrive: {
      switch (sourceMainValues.normalizedSource.values_type) {
        case GoogleDriveSourceType.Minimal:
          return <GoogleDriveMinimalDetails normalizedSource={sourceMainValues.normalizedSource} />;

        case GoogleDriveSourceType.Verbose:
          return <GoogleDriveVerboseDetails normalizedSource={sourceMainValues.normalizedSource} />;
    ...
    case SourceForUserType.StandardDocument: {
      switch (sourceMainValues.normalizedSource.values_type) {
        case StandardDocumentSourceType.Minimal:
          return (
            <StandardDocumentMinimalDetails normalizedSource={sourceMainValues.normalizedSource} />
          );

        case StandardDocumentSourceType.Verbose:
          return (
            <StandardDocumentVerboseDetails normalizedSource={sourceMainValues.normalizedSource} />
          );
