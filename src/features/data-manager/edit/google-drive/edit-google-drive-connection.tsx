...
import { DatabaseConnectionType, type GoogleDriveDatabaseConnection } from "#/types/databases";
    ...
    <div className="p-10 flex flex-col gap-5">
      <header className="flex w-full justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-3xl font-bold w-full">Google Drive Connection</span>
        </div>
      ...
      <p className="font-bold">
        Name: <span className="font-normal">{googleDriveDatabaseConnection?.name}</span>
      </p>
