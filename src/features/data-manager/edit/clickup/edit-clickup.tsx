...
export function EditClickUp() {
	const [shouldIndexEverythingDocs, setShouldIndexEverythingDocs] =
		useState(false);
	...
	useLayoutEffect(() => {
		setShouldIndexEverythingDocs(
			clickUpDatabaseConnection?.index_everything_documents ?? false,
		);
	...
	return (
		<div className="flex flex-col gap-10">
			...
			<p className="font-bold">
				Name:{" "}
				<span className="font-normal">{clickUpDatabaseConnection.name}</span>
			</p>
