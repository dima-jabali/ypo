...
export const YouTubeForm: React.FC<{
  ...
  return (
    <>
      ...
      <DialogDescription>
        To add a YouTube connection, you need to to authorize BetterBrain to connect to your desired
        YouTube&apos;s workspace.
      </DialogDescription>

      <form className="my-6 flex flex-col gap-4" ref={formRef}>
        <fieldset className="flex items-center gap-4">
          <label className="whitespace-nowrap font-bold" htmlFor="connection_name">
