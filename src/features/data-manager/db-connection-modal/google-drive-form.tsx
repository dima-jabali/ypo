...
export const GoogleDriveForm: React.FC<{
	...
	return (
		<>
			...
			<DialogDescription>
				To add a Google Drive connection, you need to to authorize BetterBrain
				to connect to your desired Google Drive&apos;s workspace.
			</DialogDescription>
			...
			<form className="flex flex-col gap-4 mt-4" ref={formRef}>
				...
				>
					...
					<p
						...
						id="description-service_account_info"
					>
						Choose the JSON file you downloaded from Google or paste it in the
						input.
					</p>
