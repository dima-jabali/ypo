"use client";
import type { IRange, languages, editor as MonacoEditorType } from "monaco-editor";
...
type MonacoEditorsInfoStorage = Map<MonacoEditorModelId | BlockUUID, MonacoEditorInfo>;
