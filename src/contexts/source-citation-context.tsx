...
type SourceCitationIdsMap = Map<SourceID | CitationNumber, CitationNumber | SourceID>;
...
export const { Provider: SourceCitationContextProvider, useStore: useSourceCitationContextStore } =
