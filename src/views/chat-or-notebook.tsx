...
import { CHAT_MESSAGE_LIST_HTML_ELEMENT_ID, createNotebookUuid, OPTIMISTIC_NEW_NOTEBOOK_ID } from "#/helpers/utils";
import {
  useHasAnyMessage,
...
import { NewCreateProjectRequestBody, useCreateNotebook } from "#/hooks/mutation/use-create-notebook";
...
function Chat() {
  ...
  return (
    ...
    <div className="@container/chat relative flex h-[calc(100vh-75px)] flex-col justify-between overflow-hidden group/chat w-full max-w-full">
      {hasAnyMessage ? (
        <ol
          className="chat-sm-grid @3xl:chat-md-grid max-h-full h-[calc(100vh-75px)] w-full max-w-full simple-scrollbar scrollbar-stable"
