...
export function useAwsBase64File({ aws_bucket, aws_key }: FetchAwsBase64FileProps) {
  ...
  return useQuery({
    ...
    queryKey: [...queryKeyFactory.get["aws-base64-file"].queryKey, aws_bucket, aws_key],
    ...
    queryFn: enabled
      ? async () => {
          ...
          invariant(file, "No fileAsBase64String!");

          return file as Base64File;
        }
      : skipToken,
