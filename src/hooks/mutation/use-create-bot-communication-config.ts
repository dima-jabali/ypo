...
export type CreateBotCommunicationConfigRequest = CreateBotCommunicationConfigBase & {
...
const mutationKey = queryKeyFactory.post["create-bot-communication-config"].queryKey;
...
export const useCreateBotCommunicationConfig = () => {
  ...
  >({
    ...
    mutationFn: async (args) => {
      ...
      const res = await clientAPI_V1.post<CreateBotCommunicationConfigResponse>(path, args);
