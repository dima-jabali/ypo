...
type SyncConnectionRequest<T extends DatabaseConnection> = T extends AirtableDatabaseConnection
  ? SyncAirtableRequest
...
export function useSyncConnection<T extends DatabaseConnection>() {
  ...
  return useMutation<SyncConnectionResponse<T>, Error, SyncConnectionRequest<T>>({
    mutationKey,
