...
import { useStore, useMembers, useEvents, useContent } from "@/lib/store";
import {
	Search,
	Users,
	Calendar,
			...
			? members
					.filter((m) =>
						selectedLocations.some(
							(loc) =>
								m.location?.includes(loc) ||
								m.city?.includes(loc) ||
								m.ypo_chapter?.includes(loc),
						),
					)
					.slice(0, 5)
			: members.slice(0, 5);
		...
		<main className="container mx-auto p-6 space-y-8">
			...
			<section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-background p-8 md:p-12 border border-primary/20">
				<div className="relative z-10">
					...
					<p className="text-lg text-muted-foreground max-w-2xl mb-6 text-pretty">
						A single, intelligent layer powering world-class member connection,
						search, personalization, and future AI experiences for 38,000 global
						executives.
					</p>
				...
				<CardHeader>
					<div className="flex items-center justify-between">
						<div>
							...
							<CardDescription>
								Latest talks and articles from YPO members
							</CardDescription>
						</div>
			...
			<section className="grid grid-cols-1 md:grid-cols-3 gap-6">
				...
				>
					...
					<CardContent>
						<p className="text-sm text-muted-foreground">
							A living model that understands relationships across chapters,
							forums, networks, industries, and interests.
						</p>
					</CardContent>
				</Card>
				...
				>
					...
					<CardContent>
						<p className="text-sm text-muted-foreground">
							Multi-modal search across members, events, and content with
							intelligent recommendations and filters.
						</p>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent>
						<p className="text-sm text-muted-foreground">
							Secure, governed AI tools via MCP for safe LLM access,
							predictions, and agentic workflows.
						</p>
					</CardContent>
				</Card>
			</section>
