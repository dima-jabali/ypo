	...
	const addItem = (category: string, value: string) => {
		...
		switch (category) {
			...
			case "goals":
				setFormData({
					...formData,
					personalGoals: [...formData.personalGoals, value],
				});
				setNewGoal("");
				break;
			case "health":
				setFormData({
					...
					ceoDNA: {
						...formData.ceoDNA,
						health: [...formData.ceoDNA.health, value],
					},
				});
				setNewHealth("");
				break;
			case "wellness":
				setFormData({
					...
					ceoDNA: {
						...formData.ceoDNA,
						wellness: [...formData.ceoDNA.wellness, value],
					},
				});
				setNewWellness("");
				break;
			case "sports":
				setFormData({
					...
					ceoDNA: {
						...formData.ceoDNA,
						sports: [...formData.ceoDNA.sports, value],
					},
				});
				setNewSport("");
				break;
			case "hobbies":
				setFormData({
					...
					ceoDNA: {
						...formData.ceoDNA,
						hobbies: [...formData.ceoDNA.hobbies, value],
					},
				});
				setNewHobby("");
				break;
				...
				<div className="lg:col-span-2 space-y-6">
							...
							<div>
								...
								{isEditing ? (
									<Textarea
										...
										onChange={(e) =>
											setFormData({ ...formData, linkedinBio: e.target.value })
										}
										rows={3}
										className="mt-2"
								...
								<TabsContent value="interests" className="mt-4 space-y-4">
									...
									{isEditing && (
										<div className="flex gap-2">
											...
											/>
											<Button onClick={() => addItem("interests", newInterest)}>
												Add
											</Button>
										</div>
									)}
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Your lifestyle, wellness, and personal interests
							</CardDescription>
						</CardHeader>
						<CardContent>
								...
								<TabsContent value="health" className="mt-4 space-y-4">
									...
									{isEditing && (
										<div className="flex gap-2">
											...
											/>
											<Button onClick={() => addItem("health", newHealth)}>
												Add
											</Button>
										</div>
									)}
								...
								<TabsContent value="wellness" className="mt-4 space-y-4">
									...
									{isEditing && (
										<div className="flex gap-2">
											...
											/>
											<Button onClick={() => addItem("wellness", newWellness)}>
												Add
											</Button>
										</div>
									)}
								...
								<TabsContent value="sports" className="mt-4 space-y-4">
									...
									{isEditing && (
										<div className="flex gap-2">
											...
											/>
											<Button onClick={() => addItem("sports", newSport)}>
												Add
											</Button>
										</div>
									)}
								...
								<TabsContent value="hobbies" className="mt-4 space-y-4">
									...
									{isEditing && (
										<div className="flex gap-2">
											...
											/>
											<Button onClick={() => addItem("hobbies", newHobby)}>
												Add
											</Button>
										</div>
									)}
