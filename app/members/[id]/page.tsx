...
export default function MemberDetailPage() {
  ...
  return (
    <main className="container px-auto w-screen p-6 flex flex-col gap-4 h-[calc(100vh-65px)] simple-scrollbar">
      {/* Back Button */}
      <Link href="/members">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {(member.hobbies || member.interests) && (
            <Card className="border-primary/20">
              <CardHeader>
                ...
                <CardDescription>Interests, hobbies and personal insights</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <div className="space-y-6">
          ...
          {currentUserId && currentUserId !== Number.parseInt(id) && (
            <ProfileSimilarityCard viewerId={currentUserId} profileId={Number.parseInt(id)} />
          )}
                ...
                <>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{member.ypo_chapter}</p>
                    </div>
                  </div>
                  <Separator />
                </>
              ...
              <CardContent className="space-y-3">
                ...
                {member.ypo_industry && (
                  <>
                    ...
                    <div>
                      <p className="text-sm font-medium">Industry</p>
                      <p className="text-sm text-muted-foreground">{member.ypo_industry}</p>
                    </div>
                  </>
                )}
              </CardContent>
