...
export function Notebook() {
	return (
		<DropWrapper>
			<ol
				className="notebook-grid max-h-full h-[calc(100%-38px)] @3xl:h-[calc(100%-46px)] w-full max-w-full simple-scrollbar scrollbar-stable"
...
function DropWrapper({ children }: React.PropsWithChildren) {
	...
	return (
		<div
			className="@container/notebook relative flex h-full w-full flex-col overflow-hidden"
