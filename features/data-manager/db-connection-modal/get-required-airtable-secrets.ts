...
const AIRTABLE_CLIENT_ID = process.env.VITE_PUBLIC_AIRTABLE_CLIENT_ID;
const ROUTE_ROOT_URL = process.env.VITE_PUBLIC_ROUTE_ROOT_URL;

if (!AIRTABLE_CLIENT_ID) {
	throw new Error("Missing VITE_PUBLIC_AIRTABLE_CLIENT_ID");
}

if (!ROUTE_ROOT_URL) {
	throw new Error("Missing VITE_PUBLIC_ROUTE_ROOT_URL");
}
