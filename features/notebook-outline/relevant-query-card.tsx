...
import { shortDateFormatter } from "../sapien/lib/utils";
import {
	getDbInfoJSX,
	getDbState,
	getQueryDescription,
...
export function RelevantQueryCard({
	...
	const [monacoEditor, setMonacoEditor] =
		useState<MonacoEditorType.IStandaloneCodeEditor>();
	...
	const [
		...
		calcOverlap: {
			...
			if (!(blockQuery && similarQuery)) {
				console.info(
					"Either blockQuery or similarQuery is empty! Not calculating overlap.",
				);
