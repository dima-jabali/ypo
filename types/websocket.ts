...
import type { BatchTablePatchUpdateResponse } from "#/features/sapien/hooks/patch/use-patch-batch-table-by-id";
...
export type WebsocketPatchBatchTableWSMessageResponse = WebSocketMessage<
	{
	...
	WebsocketEvent.PatchBatchTableWSMessage
>;

export type WebsocketUnsubscribeBatchTableOutputsResponse = WebSocketMessage<
	{ status: WebSocketAuthStatus; error: string | null },
	WebsocketEvent.UnsubscribeBatchTableOutputs
>;
...
export type WebSocketEventData =
	| WebsocketUnsubscribeBatchTableOutputsResponse
	| WebSocketSubscribeBatchTableOutputsResponse
	| WebsocketPatchBatchTableWSMessageResponse
