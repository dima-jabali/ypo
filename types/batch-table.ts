...
import type { ColumnOptionsValueOperator } from "#/features/sapien/features/conditional-execution-filters-popover/generalFilterTypes";

export type CellCoords = `${BatchTableRowIndex}-${BatchTableColumnIndex}`;
export type BatchTableToolConfigurationId = Tagged<
	number,
	"BatchTableToolConfigurationId"
>;
export type BatchTableToolSettingsId = Tagged<
	number,
	"BatchTableToolSettingsId"
>;
...
export const BATCH_TABLE_METADATA_COLUMN_TYPE_OPTIONS = Object.values(
	BatchTableMetadataColumnType,
);

export type BatchTableConditionalExecutionFilterGroup = {
	children: Array<
		BatchTableColumnChildFilter | BatchTableConditionalExecutionFilterGroup
	>;
